...
class LoginRegisterSystem(tk.Tk):
    ...
    def open_admin_panel(self):
        self.open_view(create_admin_view)

    def open_user_view(self):
        self.open_view(create_user_view)

    def open_view(self, view_factory):
        self.withdraw()
        window = view_factory(master=self, on_logout=self.show_login)
        window.focus_set()
