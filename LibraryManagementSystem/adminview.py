...
def borrow_book():
    subprocess.Popen(["python", "BB.py"])

def return_book():
    subprocess.Popen(["python", "RB.py"])
...
delete_button = tk.Button(root, text="Delete Book", command=delete_book, fg="white", bg="#135D66")
...
treeview.grid(row=11, column=0, columnspan=3, padx=10, pady=5, sticky="nsew")
