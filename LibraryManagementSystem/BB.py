...
class AdminBorrowBookWindow(tk.Toplevel):
    def __init__(self, master=None):
        ...
        buttons = [("Borrow Book", self.borrow_book), ("Back to Admin Panel", self.destroy)]
...
def create_borrow_book_window(master=None):
    return AdminBorrowBookWindow(master=master)
