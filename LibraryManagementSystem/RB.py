...
class AdminReturnBookWindow(tk.Toplevel):
    def __init__(self, master=None):
        ...
        buttons = [("Return Book", self.return_book), ("Back to Admin Panel", self.destroy)]
...
def create_return_book_window(master=None):
    return AdminReturnBookWindow(master=master)
