    ...
    if book_id and return_time:
        try:
            ...
            if result:
                ...
                update_book(
                    book_id,
                    {"quantity": quantity + 1, "return_time": return_time_dt.isoformat()},
                )
...
def back_to_admin_panel():
    ...
    subprocess.Popen(["python", "adminview.py"])  
...
buttons = [("Return Book", return_book), ("Back to Admin Panel", back_to_admin_panel)]
